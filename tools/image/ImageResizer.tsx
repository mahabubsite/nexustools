...
const ImageResizer: React.FC<{ metadata: ToolMetadata }> = ({ metadata }) => {
  ...
  return (
    <ToolTemplate
      metadata={metadata}
      howItWorks="Upload an image, set your desired dimensions, and download the resized version. All processing happens in your browser."
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    onClick={download}
                    className="flex-1 bg-brand-600 text-white py-3 rounded-lg font-bold hover:bg-brand-700 flex items-center justify-center gap-2"
                  >
