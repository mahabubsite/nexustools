...
const SlugGenerator: React.FC<{ metadata: ToolMetadata }> = ({ metadata }) => {
  ...
  return (
    <ToolTemplate
      metadata={metadata}
      howItWorks="Convert article titles or names into clean, SEO-friendly URL slugs."
    >
        ...
        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-brand-600 text-white px-6 rounded-lg font-medium hover:bg-brand-700 transition-colors disabled:opacity-50"
              disabled={!slug}
            >
