...
const LoremIpsum: React.FC<{ metadata: ToolMetadata }> = ({ metadata }) => {
  ...
  const generate = () => {
    ...
    // A real app might use a more sophisticated dictionary
  ...
  return (
    <ToolTemplate
      metadata={metadata}
      howItWorks="Generate standard Lorem Ipsum dummy text. Choose the number of paragraphs, sentences, or words you need."
    >
      <div className="p-6">
        <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-6 flex flex-wrap items-end gap-4">
            <div>
                ...
                <input 
                    ...
                    className="w-24 px-3 py-2 border border-slate-300 rounded-lg focus:ring-brand-500"
                />
            </div>
            <div>
                ...
                <select 
                    ...
                    className="px-3 py-2 border border-slate-300 rounded-lg focus:ring-brand-500 bg-white"
                >
        ...
        <div className="relative">
            <button 
                ...
                className="absolute top-2 right-2 bg-white/80 hover:bg-white text-slate-600 p-2 rounded-md backdrop-blur-sm border border-slate-200 transition-colors"
                title="Copy text"
            >
