...
const EmailExtractor: React.FC<{ metadata: ToolMetadata }> = ({ metadata }) => {
  ...
  return (
    <ToolTemplate
      metadata={metadata}
      howItWorks="Paste any text, HTML, or messy data. We'll automatically find and extract all valid email addresses for you."
    >
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              ...
              className="text-xs flex items-center gap-1 bg-white border border-slate-300 px-2 py-1 rounded hover:bg-slate-50 disabled:opacity-50"
