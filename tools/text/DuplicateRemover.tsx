...
const DuplicateRemover: React.FC<{ metadata: ToolMetadata }> = ({ metadata }) => {
  ...
  return (
    <ToolTemplate 
      metadata={metadata} 
      howItWorks="Paste your list of text items. The tool will automatically remove duplicate lines, leaving only unique entries."
    >
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 h-[600px]">
        ...
        <div className="md:col-span-2 flex justify-center gap-4">
          ...
          <button 
            ...
            className="bg-white border border-slate-300 text-slate-700 px-6 py-3 rounded-lg font-medium hover:bg-slate-50 flex items-center gap-2 disabled:opacity-50"
            disabled={!output}
          >
